...
<body>
	...
	<form action="FormUpdate4.php" method="post" enctype="multipart/form-data" >
	...
	<form action="FormUpdate2.php" method="post"> <input type="submit" name="retour" value="Retour"> </form>
