...
<body>
	...
	<div>
		<form action="FormCreate4.php" method="post">
	...
	<?php 
		...
		?>
			<div>
				<form action="FormCreate4.php" method="post"> <?php echo $value; ?> <input type="submit" name="destroy" value="Retiré le mot clé"> <input type="hidden" name="Target" value="<?php echo $key ?>"></form>
			</div>
	...
	<form action="../Create.php" method="post"> <input type="submit" name="suivant" value="Suivant"> </form>


	<form action="FormCreate3.php" method="post"> <input type="submit" name="retour" value="Retour"> </form>
